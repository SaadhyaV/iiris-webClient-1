...
import SecurityBar from "../components/charts/SecurityBar";
import SecurityArea from "../components/charts/SecurityArea";
      ...
      <div className="flex flex-shrink flex-grow items-center flex-col py-8">
        <main className="pb-8">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div>
              <h3>Alerts of Security Risk</h3>
              {/* <SecurityBar title="Alert by Location" desc="graph" /> */}
              <SecurityArea />
            </div>
            <div>
