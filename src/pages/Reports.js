                  ...
                  <div className="bg-white py-6 px-4 sm:p-6">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        Select a report to download. The CSV lets you export
                        into a spreadsheet. The PDF act as a printable
                        statements. Both format contain the same info.
                      </p>
                    </div>
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          >
                            Everday at 7:00 PM IST
                          </label>
                          <p className="text-gray-500">
                            Get notified at the end of the day.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          <label
                            ...
                            className="font-medium text-gray-700"
                          >
                            On Friday of every week at 7:00 PM IST
                          </label>
                          <p className="text-gray-500">
                            Get notified at the end of the week.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm">
                          ...
                          <p className="text-gray-500">
                            Get notified when anything important happens in your
                            account.
                          </p>
                        </div>
                      </div>
