      ...
      <div className="flex flex-shrink flex-grow flex-col py-8 px-6">
        <main className="items-start justify-start">
          ...
          <div className="center">
            <button className="mt-16" onClick={onChangeButtonClick}>
              Change
            </button>
          </div>
        </main>
...
export default DistrictWisePage;
